...
for d in d_values:
    for t in t_values:
        try:
            # Load dataset
            dataset_path = f"D:\\Proposal Skripsi gas 2024\\Skripsi Lancar Jaya\\SKENARIO_FINAL_FIX\\02_Data_Lama\\02_Data Lama\\Histogram_random_d_{d}_t_{t}.csv"
            ...
            output_path = f"D:\\Proposal Skripsi gas 2024\\Skripsi Lancar Jaya\\SKENARIO_FINAL_FIX\\02_Data_Lama\\02_Data Lama\\hasil_normalisasi_mandiri_d_{d}_t_{t}.csv"
