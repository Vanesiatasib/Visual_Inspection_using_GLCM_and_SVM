...
def main():
    # Load the dataset
    dataset_path = r"D:\Proposal Skripsi gas 2024\Skripsi Lancar Jaya\SKENARIO_FINAL_FIX\03_Gabungan\02_Gabungan Normalisasi\setelah_normalisasi_gabungan15_t_315.csv"
